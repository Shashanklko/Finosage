    ...
    const cards = [
        {
            ...
            desc: 'Sustainable monthly income from your corpus at retirement',
        },
        {
            icon: '📅',
            title: 'Years Covered',
            value: dm.yearsCovered != null ? `${dm.yearsCovered} yrs` : '—',
            desc: 'How long your corpus supports your annual withdrawal',
        },
        {
            icon: '🎯',
            title: 'Savings Gap',
            value: dm.savingsGap > 0 ? formatINR(dm.savingsGap) : '✓ On Track',
            desc: dm.savingsGap > 0 ? 'Shortfall between required & projected corpus' : 'Your savings meet the required target',
        },
        {
            icon: '📊',
