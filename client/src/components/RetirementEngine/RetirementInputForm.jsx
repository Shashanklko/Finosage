...
const fields = [
    ...
    { id: 'portfolioValue', label: 'Current Portfolio', placeholder: '5000000', unit: '₹' },
    { id: 'monthlyContribution', label: 'Monthly Contribution', placeholder: '50000', unit: '₹' },
    { id: 'expectedReturn', label: 'Expected Return', placeholder: '11', unit: '%' },
    { id: 'volatility', label: 'Volatility (σ)', placeholder: '14', unit: '%' },
    { id: 'inflationRate', label: 'Inflation Rate', placeholder: '6', unit: '%' },
    { id: 'annualWithdrawal', label: 'Annual Withdrawal', placeholder: '600000', unit: '₹' },
];
        ...
        <div className="engine-page">
            ...
            <div className="engine-page-scrollable">
                ...
                >
                    ...
                    <p className="engine-generate-note">Regime-Switching Monte Carlo · Student-t Fat Tails · Stochastic Inflation</p>
                </motion.div>
            </div>
        </div>
    );
