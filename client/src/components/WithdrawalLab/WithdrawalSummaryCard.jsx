        ...
        >
            ...
            <div className="hero-stat-layout">
                <div>
                    ...
                    <p className="hero-stat-label">Optimal Withdrawal Rate</p>
                    <p className="hero-stat-desc">
                        DP-optimized safe withdrawal rate that sustains your corpus
                        across QMC-simulated return scenarios with dynamic guardrail adjustments.
                    </p>
                </div>
                <div style={{ textAlign: 'right' }}>
                    <p className="hero-sparkline-label">CORPUS SURVIVAL</p>
